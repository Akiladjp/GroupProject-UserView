...
export default function ItemView() {
  ...
  return (
    <>
      <div className="flex flex-col justify-end w-full h-screen  md:w-[80%] m-auto lg:w-[70%] lg:m-auto lg:border lg:border-1px lg:border-black lg:justify-around lg:items-center lg:bg-slate-400 lg:p-4 ">
        <div className="w-[99%] h-[760px] m-auto lg:flex-row flex flex-col lg:justify-center lg:bg-slate-500 lg:items-center">
          ...
          <div className="w-full h-[500px]  flex flex-col justify-start px-2  lg:bg-purple-500 lg:mt-4 lg:w-[50%]">
            <div
            ...
            >
              ...
              <div>
                <h1 className="text-2xl font-bold">RS.1200/=</h1>
              </div>
